...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('tickets/importSolicitudes', 'TicketsController@importSolicitudes')->name('tickets.importSolicitudes');
    // Comments
    Route::delete('comments/destroy', 'CommentsController@massDestroy')->name('comments.massDestroy');
    Route::resource('comments', 'CommentsController');

    Route::post('comments/importSoluciones', 'CommentsController@importSoluciones')->name('comments.importSoluciones');
